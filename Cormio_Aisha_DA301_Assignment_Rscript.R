...
ggplot(df_Platform, aes(x=Platform, y=Global_Sales_ttl)) +
  geom_bar(stat='sum',
           fill='blue') +
  labs(title="Global Sales by Platform", y= "Global Sales £ (M)")+
...
ggplot(df_Platform, aes(x=Platform, y=NA_Sales_ttl)) +
  geom_bar(stat='sum',
           fill='lightgreen') +
  labs(title="North America Sales by Platform", y= "North America Sales £ (M)")+
  theme(legend.position = "none")
...
ggplot(df_Platform, aes(x=Platform, y=EU_Sales_ttl)) +
  geom_bar(stat='sum',
           fill='pink') +
  labs(title="Europe Sales by Platform", y= "Europe Sales £ (M)")+
  theme(legend.position = "none")
...
modelGE <- lm(turtle_sales2$Global_Sales ~ turtle_sales2$EU_Sales)
...
# Plot the model.
plot(turtle_sales2$Global_Sales ~ turtle_sales2$EU_Sales)
...
modelGN <- lm(turtle_sales2$Global_Sales ~ turtle_sales2$NA_Sales)
...
# Plot the model.
plot(turtle_sales2$Global_Sales ~ turtle_sales2$NA_Sales)
...
modelEN <- lm(turtle_sales2$EU_Sales ~ turtle_sales2$NA_Sales)
...
# Plot the model.
plot(turtle_sales2$EU_Sales ~ turtle_sales2$NA_Sales)
...
modelGlobal = lm(Global_Sales~NA_Sales+EU_Sales, data=turtle_sales2)
